...
<!-- evolver:rule id=r_mo1vaz7p_1a91 fitness=21 created=2026-04-16 source=reflection -->
...
<!-- evolver:rule id=r_mo1vghrx_8hvs fitness=15 created=2026-04-16 source=observation -->
...
<!-- evolver:rule id=r_mo1vqwnv_q45i fitness=12 created=2026-04-16 source=observation -->
...
<!-- evolver:rule id=r_mo1vr9tz_uuem fitness=13 created=2026-04-16 source=distillation -->
...
<!-- evolver:rule id=r_mo1vutky_d12b fitness=21 created=2026-04-16 source=reflection -->
...
<!-- evolver:rule id=r_mo1yl142_7cyp fitness=6 created=2026-04-16 source=observation -->
...
<!-- evolver:rule id=r_mo1yl145_wfrt fitness=6 created=2026-04-16 source=observation -->
- When testing refactored modules, run incremental Bash test scripts in layers (module load check → isolated unit logic → full integration) rather than one monolithic test, to isolate failures faster.
<!-- /evolver:rule -->
